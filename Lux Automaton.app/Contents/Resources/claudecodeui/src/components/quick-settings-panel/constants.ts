...
export const CHECKBOX_CLASS =
  'h-4 w-4 rounded border-gray-300 dark:border-gray-600 text-orange-600 dark:text-orange-500 focus:ring-orange-500 focus:ring-2 dark:focus:ring-orange-400 bg-gray-100 dark:bg-gray-800 checked:bg-orange-600 dark:checked:bg-orange-600';
