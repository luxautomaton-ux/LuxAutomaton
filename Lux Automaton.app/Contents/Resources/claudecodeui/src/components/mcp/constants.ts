...
export const MCP_PROVIDER_BUTTON_CLASSES: Record<McpProvider, string> = {
  claude: 'bg-orange-600 text-white hover:bg-orange-700',
  cursor: 'bg-orange-600 text-white hover:bg-orange-700',
  codex: 'bg-gray-800 text-white hover:bg-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600',
  gemini: 'bg-orange-600 text-white hover:bg-orange-700',
};
