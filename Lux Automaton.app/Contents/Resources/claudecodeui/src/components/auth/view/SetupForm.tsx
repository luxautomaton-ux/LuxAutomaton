...
export default function SetupForm() {
  ...
  return (
    <AuthScreenLayout
      title="Welcome to Lux Claude Code"
      description="Set up your account to get started"
      footerText="This is a single-user system. Only one account can be created."
      logo={<img src="/logo.png" alt="Lux Claude Code" className="h-16 w-16 object-cover rounded-lg" />}
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full rounded-md bg-orange-600 px-4 py-2 font-medium text-white transition-colors duration-200 hover:bg-orange-700 disabled:bg-orange-400"
        >
