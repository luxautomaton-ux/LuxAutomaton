...
const FILE_ICON_MAP: FileIconMap = {
  ...
  ts: { icon: FileCode2, color: 'text-orange-500' },
  tsx: { icon: FileCode2, color: 'text-orange-500' },
  mts: { icon: FileCode2, color: 'text-orange-500' },
  ...
  c: { icon: Cpu, color: 'text-orange-600' },
  h: { icon: Cpu, color: 'text-orange-400' },
  cpp: { icon: Cpu, color: 'text-orange-700' },
  hpp: { icon: Cpu, color: 'text-orange-500' },
  cc: { icon: Cpu, color: 'text-orange-700' },
  cs: { icon: Hexagon, color: 'text-orange-600' },
  swift: { icon: Flame, color: 'text-orange-500' },
  lua: { icon: SquareFunction, color: 'text-orange-500' },
  r: { icon: FlaskConical, color: 'text-orange-600' },
  html: { icon: Globe, color: 'text-orange-600' },
  htm: { icon: Globe, color: 'text-orange-600' },
  css: { icon: Hash, color: 'text-orange-500' },
  scss: { icon: Hash, color: 'text-pink-500' },
  sass: { icon: Hash, color: 'text-pink-400' },
  less: { icon: Hash, color: 'text-orange-500' },
  ...
  yaml: { icon: Settings, color: 'text-orange-400' },
  yml: { icon: Settings, color: 'text-orange-400' },
  ...
  md: { icon: BookOpen, color: 'text-orange-500' },
  mdx: { icon: BookOpen, color: 'text-orange-400' },
  ...
  ps1: { icon: Terminal, color: 'text-orange-400' },
  bat: { icon: Terminal, color: 'text-gray-500' },
  cmd: { icon: Terminal, color: 'text-gray-500' },
  png: { icon: Image, color: 'text-orange-500' },
  jpg: { icon: Image, color: 'text-orange-500' },
  jpeg: { icon: Image, color: 'text-orange-500' },
  gif: { icon: Image, color: 'text-orange-400' },
  webp: { icon: Image, color: 'text-orange-400' },
  ico: { icon: Image, color: 'text-orange-400' },
  bmp: { icon: Image, color: 'text-orange-400' },
  tiff: { icon: Image, color: 'text-orange-400' },
  ...
  wasm: { icon: Binary, color: 'text-orange-500' },
...
const FILENAME_ICON_MAP: FileIconMap = {
  Dockerfile: { icon: Box, color: 'text-orange-500' },
  'docker-compose.yml': { icon: Box, color: 'text-orange-500' },
  'docker-compose.yaml': { icon: Box, color: 'text-orange-500' },
  ...
  'yarn.lock': { icon: Lock, color: 'text-orange-400' },
  ...
  'CMakeLists.txt': { icon: Cog, color: 'text-orange-500' },
  'tsconfig.json': { icon: Braces, color: 'text-orange-500' },
  'jsconfig.json': { icon: Braces, color: 'text-yellow-500' },
  'vite.config.ts': { icon: Flame, color: 'text-orange-500' },
  'vite.config.js': { icon: Flame, color: 'text-orange-500' },
  'webpack.config.js': { icon: Cog, color: 'text-orange-500' },
  ...
  'README.md': { icon: BookOpen, color: 'text-orange-500' },
  LICENSE: { icon: FileCheck, color: 'text-gray-500' },
  'LICENSE.md': { icon: FileCheck, color: 'text-gray-500' },
  'CHANGELOG.md': { icon: Scroll, color: 'text-orange-400' },
