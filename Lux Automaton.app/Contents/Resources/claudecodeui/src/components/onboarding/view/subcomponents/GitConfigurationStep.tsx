    ...
    <div className="space-y-6">
      <div className="mb-8 text-center">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-orange-100 dark:bg-orange-900/30">
          <GitBranch className="h-8 w-8 text-orange-600 dark:text-orange-400" />
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-background px-4 py-3 text-foreground focus:border-transparent focus:outline-none focus:ring-2 focus:ring-orange-500"
