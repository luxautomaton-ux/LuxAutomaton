    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-orange-200 bg-orange-50 p-4 dark:border-orange-800 dark:bg-orange-900/20">
        ...
        <ul className="space-y-1 text-sm text-orange-800 dark:text-orange-200">
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Bash(git log:*)"</code> {t('permissions.toolExamples.bashGitLog')}</li>
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Bash(git diff:*)"</code> {t('permissions.toolExamples.bashGitDiff')}</li>
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Write"</code> {t('permissions.toolExamples.write')}</li>
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Bash(rm:*)"</code> {t('permissions.toolExamples.bashRm')}</li>
        </ul>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-orange-200 bg-orange-50 p-4 dark:border-orange-800 dark:bg-orange-900/20">
        ...
        <ul className="space-y-1 text-sm text-orange-800 dark:text-orange-200">
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Shell(ls)"</code> {t('permissions.shellExamples.ls')}</li>
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Shell(git status)"</code> {t('permissions.shellExamples.gitStatus')}</li>
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Shell(npm install)"</code> {t('permissions.shellExamples.npmInstall')}</li>
          <li><code className="rounded bg-orange-100 px-1 dark:bg-orange-800">"Shell(rm -rf)"</code> {t('permissions.shellExamples.rmRf')}</li>
        </ul>
      </div>
    </div>
  );
