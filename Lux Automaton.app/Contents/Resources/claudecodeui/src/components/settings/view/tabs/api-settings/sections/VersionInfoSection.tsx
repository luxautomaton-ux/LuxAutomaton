...
const GITHUB_REPO_URL = 'https://github.com/lux-automaton/LuxCLI';
const DISCORD_URL = 'https://github.com/LuxAI/LuxClaudeCode';
const DOCS_URL = 'https://github.com/lux-automaton/LuxCLI#readme';
const LUX_URL = 'https://github.com/lux-automaton/LuxCLI';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold text-foreground">Lux CLI</span>
              <a
                href={releasesUrl}
                target="_blank"
...
{/* Hosted CTA (OSS mode only) */}
      {!IS_PLATFORM && (
        <div className="rounded-xl border border-primary/10 bg-primary/5 p-4">
          <h4 className="text-sm font-medium text-foreground">Try Lux Automaton</h4>
          <p className="mt-1 text-xs text-muted-foreground">
            Self-hosted AI coding assistant — run locally, no subscriptions.
          </p>
          <a
            href={LUX_URL}
            target="_blank"
