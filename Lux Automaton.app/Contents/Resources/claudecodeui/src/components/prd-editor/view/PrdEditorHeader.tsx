  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? 'text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/50'
  ...
  return (
    <div className="flex min-w-0 flex-shrink-0 items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded bg-orange-600">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center">
            <div className="flex min-w-0 flex-1 items-center gap-1">
              <div className="flex min-w-0 flex-1 items-center rounded-md border border-gray-200 bg-gray-50 px-3 py-2 focus-within:border-orange-500 focus-within:ring-2 focus-within:ring-orange-500 dark:border-gray-600 dark:bg-gray-700 dark:focus-within:border-orange-400 dark:focus-within:ring-orange-400">
                <input
              ...
              <button
                ...
                className="p-1 text-gray-400 transition-colors hover:text-orange-600 dark:hover:text-orange-400"
            ...
            <div className="flex flex-shrink-0 items-center gap-2">
              <span className="whitespace-nowrap rounded bg-orange-100 px-2 py-1 text-xs text-orange-600 dark:bg-orange-900 dark:text-orange-300">
                PRD
              </span>
              {isNewFile && (
