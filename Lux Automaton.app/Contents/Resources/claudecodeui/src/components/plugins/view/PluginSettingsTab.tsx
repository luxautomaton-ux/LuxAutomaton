...
const STARTER_PLUGIN_URL = 'https://github.com/lux-automaton/LuxCLI-plugin-starter';
const TERMINAL_PLUGIN_URL = 'https://github.com/lux-automaton/LuxCLI-plugin-terminal';
...
function StarterPluginCard({ onInstall, installing }: { onInstall: () => void; installing: boolean }) {
  ...
  return (
    <div className="relative flex overflow-hidden rounded-lg border border-dashed border-border bg-card transition-all duration-200 hover:border-orange-400 dark:hover:border-orange-500">
      <div className="w-[3px] flex-shrink-0 bg-orange-500/30" />
      <div className="min-w-0 flex-1 p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2.5">
            <div className="h-5 w-5 flex-shrink-0 text-orange-500">
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="rounded bg-orange-50 px-1.5 py-0.5 text-[10px] font-medium text-orange-600 dark:bg-orange-950/50 dark:text-orange-400">
              ...
              >
                <GitBranch className="h-3 w-3" />
                lux-automaton/luxcli-plugin-starter
              </a>
            </div>
          </div>
          <button
            onClick={onInstall}
            disabled={installing}
            className="flex flex-shrink-0 items-center gap-1.5 rounded-md bg-orange-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-orange-700 disabled:opacity-50"
          >
            {installing ? (
              <Loader2 className="h-3.5 w-3.5 animate-spin" />
            ) : (
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              >
                <GitBranch className="h-3 w-3" />
                lux-automaton/luxcli-plugin-terminal
              </a>
            </div>
          </div>
          <button
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center gap-3 border-t border-border/50 pt-2">
        ...
        <span className="text-muted-foreground/20">·</span>
        <a
          href="https://github.com/lux-automaton/LuxCLI"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1 text-xs text-muted-foreground/60 transition-colors hover:text-foreground"
        >
