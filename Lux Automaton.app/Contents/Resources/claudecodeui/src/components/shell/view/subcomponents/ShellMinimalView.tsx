        ...
        <div className="absolute inset-x-0 bottom-14 z-20 border-t border-gray-700/80 bg-gray-900/95 p-3 backdrop-blur-sm md:hidden">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full rounded border border-gray-600 bg-gray-800 px-2 py-1 text-xs text-gray-100 focus:outline-none focus:ring-1 focus:ring-orange-500"
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex-1 rounded bg-orange-600 px-3 py-2 text-xs font-medium text-white hover:bg-orange-700"
              >
                Open URL
              </button>
