  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-lg dark:border-gray-700/50 dark:bg-gray-800/90 dark:shadow-2xl">
        {/* Accent line */}
        <div className="absolute left-0 right-0 top-0 h-[2px] bg-gradient-to-r from-orange-500 via-cyan-400 to-teal-400" />
        ...
        <div className="px-4 pb-2 pt-3.5">
          <div className="mb-1.5 flex items-center gap-2.5">
            ...
            <div className="relative flex-shrink-0">
              <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-br from-orange-500/10 to-cyan-500/10 dark:from-orange-400/15 dark:to-cyan-400/15">
                <svg className="h-3.5 w-3.5 text-orange-600 dark:text-orange-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2">
              ...
              {q.header && (
                <span className="inline-flex items-center rounded border border-orange-100 bg-orange-50 px-1.5 py-px text-[9px] font-semibold uppercase tracking-wider text-orange-600 dark:border-orange-800/50 dark:bg-orange-900/30 dark:text-orange-400">
                  {q.header}
                </span>
              )}
            </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            {isLast ? (
              ...
              <button
                type="button"
                onClick={() => setCurrentStep(s => s + 1)}
                className="inline-flex items-center gap-1 rounded-lg bg-gradient-to-r from-orange-600 to-orange-500 px-3.5 py-1.5 text-[11px] font-semibold text-white shadow-sm transition-all duration-200 hover:shadow-md dark:from-orange-500 dark:to-orange-600"
              >
                Next
                <span className="ml-0.5 font-mono text-[9px] opacity-70">Enter</span>
              </button>
