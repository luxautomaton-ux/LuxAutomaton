...
const borderColorMap: Record<string, string> = {
  ...
  agent: 'border-l-orange-500 dark:border-l-orange-400',
  plan: 'border-l-orange-500 dark:border-l-orange-400',
  question: 'border-l-orange-500 dark:border-l-orange-400',
