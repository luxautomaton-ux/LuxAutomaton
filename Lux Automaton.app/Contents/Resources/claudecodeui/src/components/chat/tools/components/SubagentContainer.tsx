...
export const SubagentContainer: React.FC<SubagentContainerProps> = ({
  ...
  return (
    <div className="my-1 border-l-2 border-l-orange-500 py-0.5 pl-3 dark:border-l-orange-400">
      <CollapsibleSection
        title={title}
        toolName="Task"
        open={false}
      >
        ...
        {currentTool && !isComplete && (
          <div className="mt-1 flex items-center gap-1.5 text-xs text-muted-foreground">
            <span className="h-1.5 w-1.5 flex-shrink-0 animate-pulse rounded-full bg-orange-500 dark:bg-orange-400" />
