            ...
            return (
              <div
                ...
                className={`command-item mb-0.5 flex cursor-pointer items-start rounded-md px-3 py-2.5 transition-colors ${
                  isSelected ? 'bg-orange-50 dark:bg-orange-900' : 'bg-transparent'
                }`}
              ...
              >
                ...
                {isSelected && <span className="ml-2 text-xs font-semibold text-orange-500 dark:text-orange-300">{'<-'}</span>}
              </div>
            );
          })}
        </div>
