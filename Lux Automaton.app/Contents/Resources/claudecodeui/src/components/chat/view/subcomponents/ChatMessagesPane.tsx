        ...
        <>
          ...
          {(showLoadAllOverlay || isLoadingAllMessages || loadAllJustFinished) && (
            <div className="pointer-events-none sticky top-2 z-20 flex justify-center">
              {loadAllJustFinished ? (
                ...
                <button
                  className="pointer-events-auto flex items-center space-x-2 rounded-full bg-orange-600 px-4 py-1.5 text-xs font-medium text-white shadow-lg transition-all duration-200 hover:scale-105 hover:bg-orange-700 disabled:cursor-wait disabled:opacity-75 dark:bg-orange-500 dark:hover:bg-orange-600"
          ...
          {!hasMoreMessages && chatMessages.length > visibleMessageCount && (
            <div className="border-b border-gray-200 py-2 text-center text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
              ...
              <button className="ml-1 text-orange-600 underline hover:text-orange-700" onClick={loadEarlierMessages}>
