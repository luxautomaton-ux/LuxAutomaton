    ...
    >
      {message.type === 'user' ? (
        ...
        <div className="flex w-full items-end space-x-0 sm:w-auto sm:max-w-[85%] sm:space-x-3 md:max-w-md lg:max-w-lg xl:max-w-xl">
          <div className="group flex-1 rounded-2xl rounded-br-md bg-orange-600 px-3 py-2 text-white shadow-sm sm:flex-initial sm:px-4">
            ...
            <div className="mt-1 flex items-center justify-end gap-1 text-xs text-orange-100">
          ...
          {!isGrouped && (
            <div className="hidden h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-orange-600 text-sm text-white sm:flex">
              U
            </div>
          )}
        </div>
