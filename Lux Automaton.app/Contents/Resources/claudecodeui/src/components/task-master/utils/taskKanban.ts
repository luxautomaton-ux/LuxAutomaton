...
const KANBAN_COLUMN_CONFIG = [
  ...
  },
  {
    ...
    status: 'in-progress',
    color: 'bg-orange-50 dark:bg-orange-900/50 border-orange-200 dark:border-orange-700',
    headerColor: 'bg-orange-100 dark:bg-orange-800 text-orange-800 dark:text-orange-200',
  },
  {
    id: 'done',
