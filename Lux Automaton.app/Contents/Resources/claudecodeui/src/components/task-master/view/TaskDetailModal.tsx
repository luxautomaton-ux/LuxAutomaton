...
function getPriorityBadgeClass(priority?: string): string {
  ...
  if (priority === 'low') return 'text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950';
            ...
            <div className="min-w-0 flex-1">
              ...
              {isEditMode ? (
                <input
                  ...
                  className="w-full border-b-2 border-orange-500 bg-transparent text-lg font-semibold text-gray-900 focus:outline-none dark:text-white"
                />
              ) : (
        ...
        <div className="flex-1 space-y-6 overflow-y-auto p-4 md:p-6">
                ...
                <div className="flex flex-wrap gap-1">
                  {task.dependencies.map((dependency) => (
                    <button
                      ...
                      className="rounded bg-orange-100 px-2 py-1 text-sm text-orange-700 hover:bg-orange-200 dark:bg-orange-900 dark:text-orange-300 dark:hover:bg-orange-800"
                    >
          ...
          {task.testStrategy && (
            <div className="rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              {showTestStrategy && (
                <div className="border-t border-gray-200 bg-orange-50 p-4 dark:border-gray-700 dark:bg-orange-950/30">
