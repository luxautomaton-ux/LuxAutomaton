        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={cn(
              ...
              showFilters
                ? 'bg-orange-50 dark:bg-orange-900 border-orange-200 dark:border-orange-700 text-orange-700 dark:text-orange-300'
          ...
          {hasProject && (
            <>
              <button
                onClick={onOpenHelp}
                className="rounded-lg border border-gray-300 p-2 text-gray-600 hover:bg-gray-100 hover:text-orange-600 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-orange-400"
                ...
                {existingPrds.length > 0 ? (
                  <>
                    <button
                      ...
                      className="flex items-center gap-2 rounded-lg bg-orange-600 px-3 py-2 font-medium text-white hover:bg-orange-700"
                      title={t('buttons.prdsAvailable', { count: existingPrds.length })}
                    >
                      <FileText className="h-4 w-4" />
                      <span className="hidden sm:inline">{t('buttons.prds')}</span>
                      <span className="min-w-5 rounded-full bg-orange-500 px-1.5 py-0.5 text-center text-xs">
                        {existingPrds.length}
                      </span>
                      ...
                      <div className="absolute right-0 top-full z-30 mt-2 w-56 rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
                        <div className="p-2">
                          <button
                            ...
                            className="flex w-full items-center gap-2 rounded px-3 py-2 text-left text-sm font-medium text-orange-700 hover:bg-orange-50 dark:text-orange-300 dark:hover:bg-orange-900/30"
                          >
