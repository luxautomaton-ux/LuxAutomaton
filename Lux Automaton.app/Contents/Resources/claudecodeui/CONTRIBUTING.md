...
- **Search first.** Check [existing issues](https://github.com/lux-automaton/LuxCLI/issues) and [pull requests](https://github.com/lux-automaton/LuxCLI/pulls) to avoid duplicating work.
- **Discuss first** for new features. Open an [issue](https://github.com/lux-automaton/LuxCLI/issues/new) to discuss your idea before investing time in implementation. We may already have plans or opinions on how it should work.
