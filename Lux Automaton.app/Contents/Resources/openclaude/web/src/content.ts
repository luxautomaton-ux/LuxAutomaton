export const installCommand = 'npm install -g @luxai/lux-claude-code'
...
export const features = [
  ...
  },
  {
    ...
    body: 'save model, base url, auth, and runtime defaults to .lux-claude-profile.json so every clone boots the same way.',
  },
  {
...
export const navLinks = [
  ...
  { href: 'https://github.com/LuxAI/LuxClaudeCode', label: 'github' },
] as const
